...
{
	ros::init(argc, argv, "below_image_publisher");

	if(argc != 2)
	{
        ROS_INFO("Usage: below_image_publisher <video number> ; eg: below_image_publisher 0");
        return 1;
	}
    ...
    image_transport::Publisher pub = it.advertise("camera/below_image/", 1);
